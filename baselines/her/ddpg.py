...
class DDPG(object):
    ...
    def _create_network(self, reuse=False):
        ...
        self.Q_loss_tf = tf.reduce_mean(tf.square(tf.stop_gradient(target_tf) - self.main.Q_tf)) #+tf.reduce_mean(tf.square(self.main.Q_tf_sym - self.main.Q_tf))
    ...
    def logs(self, prefix=''):
        ...
        logs += [('time(s)',(datetime.datetime.now()-self.starttime).seconds)]
